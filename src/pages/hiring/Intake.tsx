          ...
          <section>
            ...
            {rounds.map((r, i) => (
              <div key={i} className="flex gap-2 mb-2">
                ...
                <input type="email" value={r.interviewerEmail ?? ''} onChange={(e) => setRounds(rounds.map((x, j) => j === i ? { ...x, interviewerEmail: e.target.value } : x))} placeholder="Interviewer email" className={inp} />
