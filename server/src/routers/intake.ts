  ...
  try {
    ...
    if (baseJd && !differ) {
      ...
      await db.insert(jobDescriptions).values({
        ...
        workSampleInstructions: baseJd.workSampleInstructions, status: 'Draft', autoGenerated: true,
      });
      ...
      await db.insert(jobDescriptions).values({
        ...
        workSampleInstructions: jd.workSampleInstructions, autoGenerated: true,
      });
