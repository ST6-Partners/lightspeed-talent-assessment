...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_candidates_jd_id" ON "candidates" USING btree ("jd_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_candidates_stage" ON "candidates" USING btree ("current_stage");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_stage_history_candidate" ON "candidate_stage_history" USING btree ("candidate_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_email_log_candidate" ON "email_log" USING btree ("candidate_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_job_descriptions_req_id" ON "job_descriptions" USING btree ("req_id");
