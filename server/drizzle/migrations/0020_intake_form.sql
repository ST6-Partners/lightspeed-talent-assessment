-- Intake Form (slice 1): extend job_requisitions + add intake child tables. Idempotent.

-- ── New columns on job_requisitions ───────────────────────
...
-- ── awareness_list (notified, not approvers) ──────────────
...
-- ── approvals (sequential sign-off; used by slice 2) ──────
